...
MIPS_BOOTLOAD_IMAGE_PATH	= image
MIPS_BOOTLOAD_LIB_NAME		= libbootload.o
MIPS_BOOTLOAD_LIB_DIR		= image/src/app
...
#SUBDIR_EXAMPLES = examples/standalone examples/api examples/redirect examples/flash_writer_u
SUBDIR_EXAMPLES = examples/standalone examples/api examples/flash_writer_u
SUBDIR_EXAMPLES += examples/efuse_programmer
SUBDIR_EXAMPLES += examples/efuse_verify
else
...
CROSS_COMPILE ?=
   ...
   TOOLCHAIN_PREFIX := asdk-4.9.3-a53-EL-3.10-g2.19-a32nt-150615
...
LIBS-$(CONFIG_UBOOT_DEFAULT) += lib/lzma/liblzma.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += lib/lzo/liblzo.o
...
LIBS-$(CONFIG_UBOOT_DEFAULT) += fs/cramfs/libcramfs.o fs/fat/libfat.o fs/fdos/libfdos.o fs/jffs2/libjffs2.o \
	fs/reiserfs/libreiserfs.o fs/ext2/libext2fs.o fs/yaffs2/libyaffs2.o \
	fs/ubifs/libubifs.o fs/zfs/libzfs.o
LIBS-y += net/libnet.o
LIBS-y += disk/libdisk.o

LIBS-$(CONFIG_CMD_SPI_FLASH_DRIVER)  += drivers/flash/libflash.o

LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/bios_emulator/libatibiosemu.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/block/libblock.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/dma/libdma.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/fpga/libfpga.o
LIBS-y += drivers/gpio/libgpio.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/hwmon/libhwmon.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/i2c/libi2c.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/input/libinput.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/misc/libmisc.o
LIBS-y += drivers/mmc/libmmc.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/mtd/libmtd.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/mtd/nand/libnand.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/mtd/onenand/libonenand.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/mtd/ubi/libubi.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/mtd/spi/libspi_flash.o
LIBS-y += drivers/net/libnet.o
LIBS-y += drivers/net/phy/libphy.o
LIBS-y += drivers/pcb_mgr/libpcb_mgr.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/logo_disp/liblogo_disp.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/pci/libpci.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/pcmcia/libpcmcia.o
LIBS-$(CONFIG_SYS_PIN_MUX) += drivers/pinmux/$(SOC)/libpinmux.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/power/libpower.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/pwm/libpwm.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/spi/libspi.o
ifeq ($(CPU),mpc83xx)
...
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/rtc/librtc.o
LIBS-y += drivers/serial/libserial.o
LIBS-$(CONFIG_GENERIC_LPC_TPM) += drivers/tpm/libtpm.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/twserial/libtws.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/usb/eth/libusb_eth.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/usb/gadget/libusb_gadget.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/usb/host/libusb_host.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/usb/musb/libusb_musb.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/usb/phy/libusb_phy.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/usb/ulpi/libusb_ulpi.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/video/libvideo.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += drivers/watchdog/libwatchdog.o
LIBS-y += common/libcommon.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += lib/libfdt/libfdt.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += api/libapi.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += post/libpost.o
LIBS-$(CONFIG_UBOOT_DEFAULT) += test/libtest.o
LIBS-$(CONFIG_QC_VERIFY) += qc_verify/libqc_verify.o
LIBS-y += $(MIPS_BOOTLOAD_LIB_PATH)
LIBS-$(CONFIG_FT_TEST) += FTtest/libFTtest.o
LIBS-$(CONFIG_MODULE_TEST) += ModuleTest/libMTest.o FTtest/libFTtest.o
...
#
ifeq ("$(AUTORUN)", "bcldr")
    _AUTO_RUN_ = -DCONFIG_AUTO_RUN_BOOTLOADER
endif
export _AUTO_RUN_
...
$(obj)u-boot:	depend \
		$(SUBDIR_TOOLS) $(OBJS) $(LIBBOARD) $(LIBS) $(MIPS_BOOTLOAD_LIB_NAME) $(LDSCRIPT) $(obj)u-boot.lds
		$(GEN_UBOOT)
...
$(SUBDIRS):	depend
		$(MAKE) -C $@ all PRJ=$(PRJ) CUSTOMER_ID=$(CUSTOMER_ID) CHIP_ID=$(CHIP_ID) CHIP_TYPE=$(CHIP_TYPE) FLASH_TYPE=$(FLASH_TYPE)
...
clean:
	...
	@rm -f bootloader.tar
	@find $(OBJTREE) -path '$(OBJTREE)/static_lib*' -a -prune -o -type f \
