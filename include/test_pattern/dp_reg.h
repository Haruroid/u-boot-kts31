...
// Firmware Header Generate Date : 2015/6/6 18:19:17
***************************************************************/
...
#define DP_STATE                                                                     0x98017800
#define DP_STATE_reg_addr                                                            "0xD8017800"
#define DP_STATE_reg                                                                 0xD8017800
...
#define DP_CTRL                                                                      0x98017804
#define DP_CTRL_reg_addr                                                             "0xD8017804"
#define DP_CTRL_reg                                                                  0xD8017804
...
#define DP_PW_STATUS                                                                 0x98017808
#define DP_PW_STATUS_reg_addr                                                        "0xD8017808"
#define DP_PW_STATUS_reg                                                             0xD8017808
...
#define DP_PW_0                                                                      0x98017810
#define DP_PW_1                                                                      0x98017814
#define DP_PW_2                                                                      0x98017818
#define DP_PW_3                                                                      0x9801781C
#define DP_PW_0_reg_addr                                                             "0xD8017810"
#define DP_PW_1_reg_addr                                                             "0xD8017814"
#define DP_PW_2_reg_addr                                                             "0xD8017818"
#define DP_PW_3_reg_addr                                                             "0xD801781C"
#define DP_PW_0_reg                                                                  0xD8017810
#define DP_PW_1_reg                                                                  0xD8017814
#define DP_PW_2_reg                                                                  0xD8017818
#define DP_PW_3_reg                                                                  0xD801781C
...
#define DP_DBG_STATUS                                                                0x98017820
#define DP_DBG_STATUS_reg_addr                                                       "0xD8017820"
#define DP_DBG_STATUS_reg                                                            0xD8017820
...
#define DP_BIST_CTRL                                                                 0x98017824
#define DP_BIST_CTRL_reg_addr                                                        "0xD8017824"
#define DP_BIST_CTRL_reg                                                             0xD8017824
...
#define DP_BIST_RM                                                                   0x98017828
#define DP_BIST_RM_reg_addr                                                          "0xD8017828"
#define DP_BIST_RM_reg                                                               0xD8017828
...
#define DP_BIST_RM_ds_shift                                                          (10)
#define DP_BIST_RM_ds_mask                                                           (0x00000400)
#define DP_BIST_RM_ds(data)                                                          (0x00000400&((data)<<10))
#define DP_BIST_RM_ds_src(data)                                                      ((0x00000400&(data))>>10)
#define DP_BIST_RM_get_ds(data)                                                      ((0x00000400&(data))>>10)
#define DP_BIST_RM_sd_shift                                                          (9)
#define DP_BIST_RM_sd_mask                                                           (0x00000200)
#define DP_BIST_RM_sd(data)                                                          (0x00000200&((data)<<9))
#define DP_BIST_RM_sd_src(data)                                                      ((0x00000200&(data))>>9)
#define DP_BIST_RM_get_sd(data)                                                      ((0x00000200&(data))>>9)
#define DP_BIST_RM_ls_shift                                                          (8)
#define DP_BIST_RM_ls_mask                                                           (0x00000100)
#define DP_BIST_RM_ls(data)                                                          (0x00000100&((data)<<8))
#define DP_BIST_RM_ls_src(data)                                                      ((0x00000100&(data))>>8)
#define DP_BIST_RM_get_ls(data)                                                      ((0x00000100&(data))>>8)
...
#define DP_BIST_ST                                                                   0x9801782c
#define DP_BIST_ST_reg_addr                                                          "0xD801782C"
#define DP_BIST_ST_reg                                                               0xD801782C
...
#define DP_DRF_ST                                                                    0x98017830
#define DP_DRF_ST_reg_addr                                                           "0xD8017830"
#define DP_DRF_ST_reg                                                                0xD8017830
...
#define DP_DUMMY                                                                     0x98017834
#define DP_DUMMY_reg_addr                                                            "0xD8017834"
#define DP_DUMMY_reg                                                                 0xD8017834
#define set_DP_DUMMY_reg(data)   (*((volatile unsigned int*) DP_DUMMY_reg)=data)
#define get_DP_DUMMY_reg   (*((volatile unsigned int*) DP_DUMMY_reg))
#define DP_DUMMY_inst_adr                                                            "0x000D"
#define DP_DUMMY_inst                                                                0x000D
#define DP_DUMMY_dmy_shift                                                           (0)
#define DP_DUMMY_dmy_mask                                                            (0xFFFFFFFF)
#define DP_DUMMY_dmy(data)                                                           (0xFFFFFFFF&((data)<<0))
#define DP_DUMMY_dmy_src(data)                                                       ((0xFFFFFFFF&(data))>>0)
#define DP_DUMMY_get_dmy(data)                                                       ((0xFFFFFFFF&(data))>>0)


#define DP_CLK_CTRL                                                                  0x98017838
#define DP_CLK_CTRL_reg_addr                                                         "0xD8017838"
#define DP_CLK_CTRL_reg                                                              0xD8017838
#define set_DP_CLK_CTRL_reg(data)   (*((volatile unsigned int*) DP_CLK_CTRL_reg)=data)
#define get_DP_CLK_CTRL_reg   (*((volatile unsigned int*) DP_CLK_CTRL_reg))
#define DP_CLK_CTRL_inst_adr                                                         "0x000E"
#define DP_CLK_CTRL_inst                                                             0x000E
#define DP_CLK_CTRL_clk_gate_dis_shift                                               (0)
#define DP_CLK_CTRL_clk_gate_dis_mask                                                (0x00000001)
#define DP_CLK_CTRL_clk_gate_dis(data)                                               (0x00000001&((data)<<0))
#define DP_CLK_CTRL_clk_gate_dis_src(data)                                           ((0x00000001&(data))>>0)
#define DP_CLK_CTRL_get_clk_gate_dis(data)                                           ((0x00000001&(data))>>0)


#define DP_UART_CTL                                                                  0x98017840
#define DP_UART_CTL_reg_addr                                                         "0xD8017840"
#define DP_UART_CTL_reg                                                              0xD8017840
