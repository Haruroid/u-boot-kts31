...
// Firmware Header Generate Date : 2015/3/12 19:53:6
***************************************************************/
...
unsigned int     smq_cmd_swap_8B:1;
...
unsigned int     smq_xor_inst_err:1;
unsigned int     smq_xor_num_err:1;
unsigned int     smq_blk_err:1;
unsigned int     ur2_length_err_int:1;
unsigned int     ur2_rx_timeout_int:1;
unsigned int     ur2_rx_thd_int:1;
unsigned int     ur2_tx_thd_int:1;
...
unsigned int     smq_xor_inst_err_en:1;
unsigned int     smq_xor_num_err_en:1;
unsigned int     smq_blk_err_en:1;
unsigned int     ur2_length_err_int_en:1;
unsigned int     ur2_rx_timeout_int_en:1;
unsigned int     ur2_rx_thd_int_en:1;
unsigned int     ur2_tx_thd_int_en:1;
...
typedef struct 
{
unsigned int     smq_base:28;
unsigned int     reserved_0:4;
}MD_SMQBASE;

typedef struct 
{
unsigned int     smq_limit:28;
unsigned int     reserved_0:4;
}MD_SMQLIMIT;

typedef struct 
{
unsigned int     smq_rdptr:28;
unsigned int     reserved_0:4;
}MD_SMQRDPTR;

typedef struct 
{
unsigned int     smq_wrptr:28;
unsigned int     reserved_0:4;
}MD_SMQWRPTR;
...
{
unsigned int     reserved_0:27;
unsigned int     vmq_cmd_swap_8B:1;
...
{
unsigned int     reserved_0:9;
unsigned int     vmq_xor_inst_err:1;
unsigned int     vmq_xor_num_err:1;
unsigned int     vmq_blk_err:1;
...
{
unsigned int     reserved_0:8;
unsigned int     vmq_xor_inst_err_en:1;
unsigned int     vmq_xor_num_err_en:1;
unsigned int     vmq_blk_err_en:1;
unsigned int     reserved_1:14;
...
typedef struct 
{
unsigned int     vmq_base:28;
unsigned int     reserved_0:4;
}MD_VMQBASE;

typedef struct 
{
unsigned int     vmq_limit:28;
unsigned int     reserved_0:4;
}MD_VMQLIMIT;

typedef struct 
{
unsigned int     vmq_rdptr:28;
unsigned int     reserved_0:4;
}MD_VMQRDPTR;

typedef struct 
{
unsigned int     vmq_wrptr:28;
unsigned int     reserved_0:4;
}MD_VMQWRPTR;
...
{
unsigned int     reserved_0:27;
unsigned int     kmq_cmd_swap_8B:1;
...
{
unsigned int     reserved_0:9;
unsigned int     kmq_xor_inst_err:1;
unsigned int     kmq_xor_num_err:1;
unsigned int     kmq_blk_err:1;
unsigned int     reserved_1:14;
...
{
unsigned int     reserved_0:8;
unsigned int     kmq_xor_inst_err_en:1;
unsigned int     kmq_xor_num_err_en:1;
unsigned int     kmq_blk_err_en:1;
unsigned int     reserved_1:14;
...
typedef struct 
{
unsigned int     kmq_base:28;
unsigned int     reserved_0:4;
}MD_KMQBASE;

typedef struct 
{
unsigned int     kmq_limit:28;
unsigned int     reserved_0:4;
}MD_KMQLIMIT;

typedef struct 
{
unsigned int     kmq_rdptr:28;
unsigned int     reserved_0:4;
}MD_KMQRDPTR;

typedef struct 
{
unsigned int     kmq_wrptr:28;
unsigned int     reserved_0:4;
}MD_KMQWRPTR;
...
typedef struct 
{
unsigned int     fdma_ddr_saddr:32;
}MD_FDMA_DDR_SADDR;

typedef struct 
{
unsigned int     reserved_0:6;
unsigned int     fdma_fl_saddr:26;
}MD_FDMA_FL_SADDR;
...
typedef struct 
{
unsigned int     tx_base:29;
unsigned int     reserved_0:3;
}MD_UR_TXBASE;

typedef struct 
{
unsigned int     tx_limit:29;
unsigned int     reserved_0:3;
}MD_UR_TXLIMIT;

typedef struct 
{
unsigned int     tx_wrptr:32;
}MD_UR_TXWRPTR;

typedef struct 
{
unsigned int     tx_rdptr:32;
}MD_UR_TXRDPTR;
...
typedef struct 
{
unsigned int     rx_base:29;
unsigned int     reserved_0:3;
}MD_UR_RXBASE;

typedef struct 
{
unsigned int     rx_limit:29;
unsigned int     reserved_0:3;
}MD_UR_RXLIMIT;

typedef struct 
{
unsigned int     rx_wrptr:32;
}MD_UR_RXWRPTR;

typedef struct 
{
unsigned int     rx_rdptr:32;
}MD_UR_RXRDPTR;
...
typedef struct 
{
unsigned int     gsp_tx_base:29;
unsigned int     reserved_0:3;
}MD_GSP_TXBASE;

typedef struct 
{
unsigned int     gsp_tx_limit:29;
unsigned int     reserved_0:3;
}MD_GSP_TXLIMIT;

typedef struct 
{
unsigned int     gsp_tx_wrptr:32;
}MD_GSP_TXWRPTR;

typedef struct 
{
unsigned int     gsp_tx_rdptr:32;
}MD_GSP_TXRDPTR;
...
typedef struct 
{
unsigned int     gsp_rx_base:29;
unsigned int     reserved_0:3;
}MD_GSP_RXBASE;

typedef struct 
{
unsigned int     gsp_rx_limit:29;
unsigned int     reserved_0:3;
}MD_GSP_RXLIMIT;

typedef struct 
{
unsigned int     gsp_rx_wrptr:32;
}MD_GSP_RXWRPTR;

typedef struct 
{
unsigned int     gsp_rx_rdptr:32;
}MD_GSP_RXRDPTR;
...
typedef struct 
{
unsigned int     gsp_txbasic_base:29;
unsigned int     reserved_0:3;
}MD_GSP_TXBASICBASE;

typedef struct 
{
unsigned int     gsp_txbasic_limit:29;
unsigned int     reserved_0:3;
}MD_GSP_TXBASICLIMIT;

typedef struct 
{
unsigned int     gsp_txbasic_wrptr:32;
}MD_GSP_TXBASICWRPTR;

typedef struct 
{
unsigned int     gsp_txbasic_rdptr:32;
}MD_GSP_TXBASICRDPTR;
...
typedef struct 
{
unsigned int     gsp_txdat_base:29;
unsigned int     reserved_0:3;
}MD_GSP_TXDATBASE;

typedef struct 
{
unsigned int     gsp_txdat_limit:29;
unsigned int     reserved_0:3;
}MD_GSP_TXDATLIMIT;

typedef struct 
{
unsigned int     gsp_txdat_wrptr:32;
}MD_GSP_TXDATWRPTR;

typedef struct 
{
unsigned int     gsp_txdat_rdptr:32;
}MD_GSP_TXDATRDPTR;
...
unsigned int     gsp_cmd_swap_8B:1;
unsigned int     gsp_cmd_swap_4B:1;
}MD_GSP_CTRL;
...
typedef struct 
{
unsigned int     ur2_tx_base:29;
unsigned int     reserved_0:3;
}MD_UR2_TXBASE;

typedef struct 
{
unsigned int     ur2_tx_limit:29;
unsigned int     reserved_0:3;
}MD_UR2_TXLIMIT;

typedef struct 
{
unsigned int     ur2_tx_wrptr:32;
}MD_UR2_TXWRPTR;

typedef struct 
{
unsigned int     ur2_tx_rdptr:32;
}MD_UR2_TXRDPTR;

typedef struct 
{
unsigned int     ur2_tx_thd:32;
}MD_UR2_TXTHD;

typedef struct 
{
unsigned int     ur2_rx_base:29;
unsigned int     reserved_0:3;
}MD_UR2_RXBASE;

typedef struct 
{
unsigned int     ur2_rx_limit:29;
unsigned int     reserved_0:3;
}MD_UR2_RXLIMIT;

typedef struct 
{
unsigned int     ur2_rx_wrptr:32;
}MD_UR2_RXWRPTR;

typedef struct 
{
unsigned int     ur2_rx_rdptr:32;
}MD_UR2_RXRDPTR;

typedef struct 
{
unsigned int     ur2_rx_thd:32;
}MD_UR2_RXTHD;

typedef struct 
{
unsigned int     reserved_0:31;
unsigned int     ur2_ur_en:1;
}MD_UR2_ENABLE;

typedef struct 
{
unsigned int     reserved_0:23;
unsigned int     endian_sel:1;
unsigned int     reserved_1:4;
unsigned int     db1_ls_en:1;
unsigned int     db0_ls_en:1;
unsigned int     ib_ls_en:1;
...
#define MD_SMQ_CNTL_smq_cmd_swap_8B_shift                                            (4)
#define MD_SMQ_CNTL_smq_cmd_swap_8B_mask                                             (0x00000010)
#define MD_SMQ_CNTL_smq_cmd_swap_8B(data)                                            (0x00000010&((data)<<4))
#define MD_SMQ_CNTL_smq_cmd_swap_8B_src(data)                                        ((0x00000010&(data))>>4)
#define MD_SMQ_CNTL_get_smq_cmd_swap_8B(data)                                        ((0x00000010&(data))>>4)
...
#define MD_SMQ_INT_STATUS_smq_xor_inst_err_shift                                     (22)
#define MD_SMQ_INT_STATUS_smq_xor_inst_err_mask                                      (0x00400000)
#define MD_SMQ_INT_STATUS_smq_xor_inst_err(data)                                     (0x00400000&((data)<<22))
#define MD_SMQ_INT_STATUS_smq_xor_inst_err_src(data)                                 ((0x00400000&(data))>>22)
#define MD_SMQ_INT_STATUS_get_smq_xor_inst_err(data)                                 ((0x00400000&(data))>>22)
#define MD_SMQ_INT_STATUS_smq_xor_num_err_shift                                      (21)
#define MD_SMQ_INT_STATUS_smq_xor_num_err_mask                                       (0x00200000)
#define MD_SMQ_INT_STATUS_smq_xor_num_err(data)                                      (0x00200000&((data)<<21))
#define MD_SMQ_INT_STATUS_smq_xor_num_err_src(data)                                  ((0x00200000&(data))>>21)
#define MD_SMQ_INT_STATUS_get_smq_xor_num_err(data)                                  ((0x00200000&(data))>>21)
#define MD_SMQ_INT_STATUS_smq_blk_err_shift                                          (20)
#define MD_SMQ_INT_STATUS_smq_blk_err_mask                                           (0x00100000)
#define MD_SMQ_INT_STATUS_smq_blk_err(data)                                          (0x00100000&((data)<<20))
#define MD_SMQ_INT_STATUS_smq_blk_err_src(data)                                      ((0x00100000&(data))>>20)
#define MD_SMQ_INT_STATUS_get_smq_blk_err(data)                                      ((0x00100000&(data))>>20)
#define MD_SMQ_INT_STATUS_ur2_length_err_int_shift                                   (19)
#define MD_SMQ_INT_STATUS_ur2_length_err_int_mask                                    (0x00080000)
#define MD_SMQ_INT_STATUS_ur2_length_err_int(data)                                   (0x00080000&((data)<<19))
#define MD_SMQ_INT_STATUS_ur2_length_err_int_src(data)                               ((0x00080000&(data))>>19)
#define MD_SMQ_INT_STATUS_get_ur2_length_err_int(data)                               ((0x00080000&(data))>>19)
#define MD_SMQ_INT_STATUS_ur2_rx_timeout_int_shift                                   (18)
#define MD_SMQ_INT_STATUS_ur2_rx_timeout_int_mask                                    (0x00040000)
#define MD_SMQ_INT_STATUS_ur2_rx_timeout_int(data)                                   (0x00040000&((data)<<18))
#define MD_SMQ_INT_STATUS_ur2_rx_timeout_int_src(data)                               ((0x00040000&(data))>>18)
#define MD_SMQ_INT_STATUS_get_ur2_rx_timeout_int(data)                               ((0x00040000&(data))>>18)
#define MD_SMQ_INT_STATUS_ur2_rx_thd_int_shift                                       (17)
#define MD_SMQ_INT_STATUS_ur2_rx_thd_int_mask                                        (0x00020000)
#define MD_SMQ_INT_STATUS_ur2_rx_thd_int(data)                                       (0x00020000&((data)<<17))
#define MD_SMQ_INT_STATUS_ur2_rx_thd_int_src(data)                                   ((0x00020000&(data))>>17)
#define MD_SMQ_INT_STATUS_get_ur2_rx_thd_int(data)                                   ((0x00020000&(data))>>17)
#define MD_SMQ_INT_STATUS_ur2_tx_thd_int_shift                                       (16)
#define MD_SMQ_INT_STATUS_ur2_tx_thd_int_mask                                        (0x00010000)
#define MD_SMQ_INT_STATUS_ur2_tx_thd_int(data)                                       (0x00010000&((data)<<16))
#define MD_SMQ_INT_STATUS_ur2_tx_thd_int_src(data)                                   ((0x00010000&(data))>>16)
#define MD_SMQ_INT_STATUS_get_ur2_tx_thd_int(data)                                   ((0x00010000&(data))>>16)
...
#define MD_SMQ_INT_ENABLE_smq_xor_inst_err_en_shift                                  (23)
#define MD_SMQ_INT_ENABLE_smq_xor_inst_err_en_mask                                   (0x00800000)
#define MD_SMQ_INT_ENABLE_smq_xor_inst_err_en(data)                                  (0x00800000&((data)<<23))
#define MD_SMQ_INT_ENABLE_smq_xor_inst_err_en_src(data)                              ((0x00800000&(data))>>23)
#define MD_SMQ_INT_ENABLE_get_smq_xor_inst_err_en(data)                              ((0x00800000&(data))>>23)
#define MD_SMQ_INT_ENABLE_smq_xor_num_err_en_shift                                   (22)
#define MD_SMQ_INT_ENABLE_smq_xor_num_err_en_mask                                    (0x00400000)
#define MD_SMQ_INT_ENABLE_smq_xor_num_err_en(data)                                   (0x00400000&((data)<<22))
#define MD_SMQ_INT_ENABLE_smq_xor_num_err_en_src(data)                               ((0x00400000&(data))>>22)
#define MD_SMQ_INT_ENABLE_get_smq_xor_num_err_en(data)                               ((0x00400000&(data))>>22)
#define MD_SMQ_INT_ENABLE_smq_blk_err_en_shift                                       (21)
#define MD_SMQ_INT_ENABLE_smq_blk_err_en_mask                                        (0x00200000)
#define MD_SMQ_INT_ENABLE_smq_blk_err_en(data)                                       (0x00200000&((data)<<21))
#define MD_SMQ_INT_ENABLE_smq_blk_err_en_src(data)                                   ((0x00200000&(data))>>21)
#define MD_SMQ_INT_ENABLE_get_smq_blk_err_en(data)                                   ((0x00200000&(data))>>21)
#define MD_SMQ_INT_ENABLE_ur2_length_err_int_en_shift                                (20)
#define MD_SMQ_INT_ENABLE_ur2_length_err_int_en_mask                                 (0x00100000)
#define MD_SMQ_INT_ENABLE_ur2_length_err_int_en(data)                                (0x00100000&((data)<<20))
#define MD_SMQ_INT_ENABLE_ur2_length_err_int_en_src(data)                            ((0x00100000&(data))>>20)
#define MD_SMQ_INT_ENABLE_get_ur2_length_err_int_en(data)                            ((0x00100000&(data))>>20)
#define MD_SMQ_INT_ENABLE_ur2_rx_timeout_int_en_shift                                (19)
#define MD_SMQ_INT_ENABLE_ur2_rx_timeout_int_en_mask                                 (0x00080000)
#define MD_SMQ_INT_ENABLE_ur2_rx_timeout_int_en(data)                                (0x00080000&((data)<<19))
#define MD_SMQ_INT_ENABLE_ur2_rx_timeout_int_en_src(data)                            ((0x00080000&(data))>>19)
#define MD_SMQ_INT_ENABLE_get_ur2_rx_timeout_int_en(data)                            ((0x00080000&(data))>>19)
#define MD_SMQ_INT_ENABLE_ur2_rx_thd_int_en_shift                                    (18)
#define MD_SMQ_INT_ENABLE_ur2_rx_thd_int_en_mask                                     (0x00040000)
#define MD_SMQ_INT_ENABLE_ur2_rx_thd_int_en(data)                                    (0x00040000&((data)<<18))
#define MD_SMQ_INT_ENABLE_ur2_rx_thd_int_en_src(data)                                ((0x00040000&(data))>>18)
#define MD_SMQ_INT_ENABLE_get_ur2_rx_thd_int_en(data)                                ((0x00040000&(data))>>18)
#define MD_SMQ_INT_ENABLE_ur2_tx_thd_int_en_shift                                    (17)
#define MD_SMQ_INT_ENABLE_ur2_tx_thd_int_en_mask                                     (0x00020000)
#define MD_SMQ_INT_ENABLE_ur2_tx_thd_int_en(data)                                    (0x00020000&((data)<<17))
#define MD_SMQ_INT_ENABLE_ur2_tx_thd_int_en_src(data)                                ((0x00020000&(data))>>17)
#define MD_SMQ_INT_ENABLE_get_ur2_tx_thd_int_en(data)                                ((0x00020000&(data))>>17)
...
#define MD_SMQBASE_smq_base_mask                                                     (0xFFFFFFF0)
#define MD_SMQBASE_smq_base(data)                                                    (0xFFFFFFF0&((data)<<4))
#define MD_SMQBASE_smq_base_src(data)                                                ((0xFFFFFFF0&(data))>>4)
#define MD_SMQBASE_get_smq_base(data)                                                ((0xFFFFFFF0&(data))>>4)
...
#define MD_SMQLIMIT_smq_limit_mask                                                   (0xFFFFFFF0)
#define MD_SMQLIMIT_smq_limit(data)                                                  (0xFFFFFFF0&((data)<<4))
#define MD_SMQLIMIT_smq_limit_src(data)                                              ((0xFFFFFFF0&(data))>>4)
#define MD_SMQLIMIT_get_smq_limit(data)                                              ((0xFFFFFFF0&(data))>>4)
...
#define MD_SMQRDPTR_smq_rdptr_mask                                                   (0xFFFFFFF0)
#define MD_SMQRDPTR_smq_rdptr(data)                                                  (0xFFFFFFF0&((data)<<4))
#define MD_SMQRDPTR_smq_rdptr_src(data)                                              ((0xFFFFFFF0&(data))>>4)
#define MD_SMQRDPTR_get_smq_rdptr(data)                                              ((0xFFFFFFF0&(data))>>4)
...
#define MD_SMQWRPTR_smq_wrptr_mask                                                   (0xFFFFFFF0)
#define MD_SMQWRPTR_smq_wrptr(data)                                                  (0xFFFFFFF0&((data)<<4))
#define MD_SMQWRPTR_smq_wrptr_src(data)                                              ((0xFFFFFFF0&(data))>>4)
#define MD_SMQWRPTR_get_smq_wrptr(data)                                              ((0xFFFFFFF0&(data))>>4)
...
#define MD_VMQ_CNTL_vmq_cmd_swap_8B_shift                                            (4)
#define MD_VMQ_CNTL_vmq_cmd_swap_8B_mask                                             (0x00000010)
#define MD_VMQ_CNTL_vmq_cmd_swap_8B(data)                                            (0x00000010&((data)<<4))
#define MD_VMQ_CNTL_vmq_cmd_swap_8B_src(data)                                        ((0x00000010&(data))>>4)
#define MD_VMQ_CNTL_get_vmq_cmd_swap_8B(data)                                        ((0x00000010&(data))>>4)
...
#define MD_VMQ_INT_STATUS_vmq_xor_inst_err_shift                                     (22)
#define MD_VMQ_INT_STATUS_vmq_xor_inst_err_mask                                      (0x00400000)
#define MD_VMQ_INT_STATUS_vmq_xor_inst_err(data)                                     (0x00400000&((data)<<22))
#define MD_VMQ_INT_STATUS_vmq_xor_inst_err_src(data)                                 ((0x00400000&(data))>>22)
#define MD_VMQ_INT_STATUS_get_vmq_xor_inst_err(data)                                 ((0x00400000&(data))>>22)
#define MD_VMQ_INT_STATUS_vmq_xor_num_err_shift                                      (21)
#define MD_VMQ_INT_STATUS_vmq_xor_num_err_mask                                       (0x00200000)
#define MD_VMQ_INT_STATUS_vmq_xor_num_err(data)                                      (0x00200000&((data)<<21))
#define MD_VMQ_INT_STATUS_vmq_xor_num_err_src(data)                                  ((0x00200000&(data))>>21)
#define MD_VMQ_INT_STATUS_get_vmq_xor_num_err(data)                                  ((0x00200000&(data))>>21)
#define MD_VMQ_INT_STATUS_vmq_blk_err_shift                                          (20)
#define MD_VMQ_INT_STATUS_vmq_blk_err_mask                                           (0x00100000)
#define MD_VMQ_INT_STATUS_vmq_blk_err(data)                                          (0x00100000&((data)<<20))
#define MD_VMQ_INT_STATUS_vmq_blk_err_src(data)                                      ((0x00100000&(data))>>20)
#define MD_VMQ_INT_STATUS_get_vmq_blk_err(data)                                      ((0x00100000&(data))>>20)
...
#define MD_VMQ_INT_ENABLE_vmq_xor_inst_err_en_shift                                  (23)
#define MD_VMQ_INT_ENABLE_vmq_xor_inst_err_en_mask                                   (0x00800000)
#define MD_VMQ_INT_ENABLE_vmq_xor_inst_err_en(data)                                  (0x00800000&((data)<<23))
#define MD_VMQ_INT_ENABLE_vmq_xor_inst_err_en_src(data)                              ((0x00800000&(data))>>23)
#define MD_VMQ_INT_ENABLE_get_vmq_xor_inst_err_en(data)                              ((0x00800000&(data))>>23)
#define MD_VMQ_INT_ENABLE_vmq_xor_num_err_en_shift                                   (22)
#define MD_VMQ_INT_ENABLE_vmq_xor_num_err_en_mask                                    (0x00400000)
#define MD_VMQ_INT_ENABLE_vmq_xor_num_err_en(data)                                   (0x00400000&((data)<<22))
#define MD_VMQ_INT_ENABLE_vmq_xor_num_err_en_src(data)                               ((0x00400000&(data))>>22)
#define MD_VMQ_INT_ENABLE_get_vmq_xor_num_err_en(data)                               ((0x00400000&(data))>>22)
#define MD_VMQ_INT_ENABLE_vmq_blk_err_en_shift                                       (21)
#define MD_VMQ_INT_ENABLE_vmq_blk_err_en_mask                                        (0x00200000)
#define MD_VMQ_INT_ENABLE_vmq_blk_err_en(data)                                       (0x00200000&((data)<<21))
#define MD_VMQ_INT_ENABLE_vmq_blk_err_en_src(data)                                   ((0x00200000&(data))>>21)
#define MD_VMQ_INT_ENABLE_get_vmq_blk_err_en(data)                                   ((0x00200000&(data))>>21)
...
#define MD_VMQBASE_vmq_base_mask                                                     (0xFFFFFFF0)
#define MD_VMQBASE_vmq_base(data)                                                    (0xFFFFFFF0&((data)<<4))
#define MD_VMQBASE_vmq_base_src(data)                                                ((0xFFFFFFF0&(data))>>4)
#define MD_VMQBASE_get_vmq_base(data)                                                ((0xFFFFFFF0&(data))>>4)
...
#define MD_VMQLIMIT_vmq_limit_mask                                                   (0xFFFFFFF0)
#define MD_VMQLIMIT_vmq_limit(data)                                                  (0xFFFFFFF0&((data)<<4))
#define MD_VMQLIMIT_vmq_limit_src(data)                                              ((0xFFFFFFF0&(data))>>4)
#define MD_VMQLIMIT_get_vmq_limit(data)                                              ((0xFFFFFFF0&(data))>>4)
...
#define MD_VMQRDPTR_vmq_rdptr_mask                                                   (0xFFFFFFF0)
#define MD_VMQRDPTR_vmq_rdptr(data)                                                  (0xFFFFFFF0&((data)<<4))
#define MD_VMQRDPTR_vmq_rdptr_src(data)                                              ((0xFFFFFFF0&(data))>>4)
#define MD_VMQRDPTR_get_vmq_rdptr(data)                                              ((0xFFFFFFF0&(data))>>4)
...
#define MD_VMQWRPTR_vmq_wrptr_mask                                                   (0xFFFFFFF0)
#define MD_VMQWRPTR_vmq_wrptr(data)                                                  (0xFFFFFFF0&((data)<<4))
#define MD_VMQWRPTR_vmq_wrptr_src(data)                                              ((0xFFFFFFF0&(data))>>4)
#define MD_VMQWRPTR_get_vmq_wrptr(data)                                              ((0xFFFFFFF0&(data))>>4)
...
#define MD_KMQ_CNTL_kmq_cmd_swap_8B_shift                                            (4)
#define MD_KMQ_CNTL_kmq_cmd_swap_8B_mask                                             (0x00000010)
#define MD_KMQ_CNTL_kmq_cmd_swap_8B(data)                                            (0x00000010&((data)<<4))
#define MD_KMQ_CNTL_kmq_cmd_swap_8B_src(data)                                        ((0x00000010&(data))>>4)
#define MD_KMQ_CNTL_get_kmq_cmd_swap_8B(data)                                        ((0x00000010&(data))>>4)
...
#define MD_KMQ_INT_STATUS_kmq_xor_inst_err_shift                                     (22)
#define MD_KMQ_INT_STATUS_kmq_xor_inst_err_mask                                      (0x00400000)
#define MD_KMQ_INT_STATUS_kmq_xor_inst_err(data)                                     (0x00400000&((data)<<22))
#define MD_KMQ_INT_STATUS_kmq_xor_inst_err_src(data)                                 ((0x00400000&(data))>>22)
#define MD_KMQ_INT_STATUS_get_kmq_xor_inst_err(data)                                 ((0x00400000&(data))>>22)
#define MD_KMQ_INT_STATUS_kmq_xor_num_err_shift                                      (21)
#define MD_KMQ_INT_STATUS_kmq_xor_num_err_mask                                       (0x00200000)
#define MD_KMQ_INT_STATUS_kmq_xor_num_err(data)                                      (0x00200000&((data)<<21))
#define MD_KMQ_INT_STATUS_kmq_xor_num_err_src(data)                                  ((0x00200000&(data))>>21)
#define MD_KMQ_INT_STATUS_get_kmq_xor_num_err(data)                                  ((0x00200000&(data))>>21)
#define MD_KMQ_INT_STATUS_kmq_blk_err_shift                                          (20)
#define MD_KMQ_INT_STATUS_kmq_blk_err_mask                                           (0x00100000)
#define MD_KMQ_INT_STATUS_kmq_blk_err(data)                                          (0x00100000&((data)<<20))
#define MD_KMQ_INT_STATUS_kmq_blk_err_src(data)                                      ((0x00100000&(data))>>20)
#define MD_KMQ_INT_STATUS_get_kmq_blk_err(data)                                      ((0x00100000&(data))>>20)
...
#define MD_KMQ_INT_ENABLE_kmq_xor_inst_err_en_shift                                  (23)
#define MD_KMQ_INT_ENABLE_kmq_xor_inst_err_en_mask                                   (0x00800000)
#define MD_KMQ_INT_ENABLE_kmq_xor_inst_err_en(data)                                  (0x00800000&((data)<<23))
#define MD_KMQ_INT_ENABLE_kmq_xor_inst_err_en_src(data)                              ((0x00800000&(data))>>23)
#define MD_KMQ_INT_ENABLE_get_kmq_xor_inst_err_en(data)                              ((0x00800000&(data))>>23)
#define MD_KMQ_INT_ENABLE_kmq_xor_num_err_en_shift                                   (22)
#define MD_KMQ_INT_ENABLE_kmq_xor_num_err_en_mask                                    (0x00400000)
#define MD_KMQ_INT_ENABLE_kmq_xor_num_err_en(data)                                   (0x00400000&((data)<<22))
#define MD_KMQ_INT_ENABLE_kmq_xor_num_err_en_src(data)                               ((0x00400000&(data))>>22)
#define MD_KMQ_INT_ENABLE_get_kmq_xor_num_err_en(data)                               ((0x00400000&(data))>>22)
#define MD_KMQ_INT_ENABLE_kmq_blk_err_en_shift                                       (21)
#define MD_KMQ_INT_ENABLE_kmq_blk_err_en_mask                                        (0x00200000)
#define MD_KMQ_INT_ENABLE_kmq_blk_err_en(data)                                       (0x00200000&((data)<<21))
#define MD_KMQ_INT_ENABLE_kmq_blk_err_en_src(data)                                   ((0x00200000&(data))>>21)
#define MD_KMQ_INT_ENABLE_get_kmq_blk_err_en(data)                                   ((0x00200000&(data))>>21)
...
#define MD_KMQBASE_kmq_base_mask                                                     (0xFFFFFFF0)
#define MD_KMQBASE_kmq_base(data)                                                    (0xFFFFFFF0&((data)<<4))
#define MD_KMQBASE_kmq_base_src(data)                                                ((0xFFFFFFF0&(data))>>4)
#define MD_KMQBASE_get_kmq_base(data)                                                ((0xFFFFFFF0&(data))>>4)
...
#define MD_KMQLIMIT_kmq_limit_mask                                                   (0xFFFFFFF0)
#define MD_KMQLIMIT_kmq_limit(data)                                                  (0xFFFFFFF0&((data)<<4))
#define MD_KMQLIMIT_kmq_limit_src(data)                                              ((0xFFFFFFF0&(data))>>4)
#define MD_KMQLIMIT_get_kmq_limit(data)                                              ((0xFFFFFFF0&(data))>>4)
...
#define MD_KMQRDPTR_kmq_rdptr_mask                                                   (0xFFFFFFF0)
#define MD_KMQRDPTR_kmq_rdptr(data)                                                  (0xFFFFFFF0&((data)<<4))
#define MD_KMQRDPTR_kmq_rdptr_src(data)                                              ((0xFFFFFFF0&(data))>>4)
#define MD_KMQRDPTR_get_kmq_rdptr(data)                                              ((0xFFFFFFF0&(data))>>4)
...
#define MD_KMQWRPTR_kmq_wrptr_mask                                                   (0xFFFFFFF0)
#define MD_KMQWRPTR_kmq_wrptr(data)                                                  (0xFFFFFFF0&((data)<<4))
#define MD_KMQWRPTR_kmq_wrptr_src(data)                                              ((0xFFFFFFF0&(data))>>4)
#define MD_KMQWRPTR_get_kmq_wrptr(data)                                              ((0xFFFFFFF0&(data))>>4)
...
#define MD_FDMA_DDR_SADDR_fdma_ddr_saddr_mask                                        (0xFFFFFFFF)
#define MD_FDMA_DDR_SADDR_fdma_ddr_saddr(data)                                       (0xFFFFFFFF&((data)<<0))
#define MD_FDMA_DDR_SADDR_fdma_ddr_saddr_src(data)                                   ((0xFFFFFFFF&(data))>>0)
#define MD_FDMA_DDR_SADDR_get_fdma_ddr_saddr(data)                                   ((0xFFFFFFFF&(data))>>0)
...
#define MD_FDMA_FL_SADDR_fdma_fl_saddr_mask                                          (0x03FFFFFF)
#define MD_FDMA_FL_SADDR_fdma_fl_saddr(data)                                         (0x03FFFFFF&((data)<<0))
#define MD_FDMA_FL_SADDR_fdma_fl_saddr_src(data)                                     ((0x03FFFFFF&(data))>>0)
#define MD_FDMA_FL_SADDR_get_fdma_fl_saddr(data)                                     ((0x03FFFFFF&(data))>>0)
...
#define MD_UR_TXBASE_tx_base_mask                                                    (0xFFFFFFF8)
#define MD_UR_TXBASE_tx_base(data)                                                   (0xFFFFFFF8&((data)<<3))
#define MD_UR_TXBASE_tx_base_src(data)                                               ((0xFFFFFFF8&(data))>>3)
#define MD_UR_TXBASE_get_tx_base(data)                                               ((0xFFFFFFF8&(data))>>3)
...
#define MD_UR_TXLIMIT_tx_limit_mask                                                  (0xFFFFFFF8)
#define MD_UR_TXLIMIT_tx_limit(data)                                                 (0xFFFFFFF8&((data)<<3))
#define MD_UR_TXLIMIT_tx_limit_src(data)                                             ((0xFFFFFFF8&(data))>>3)
#define MD_UR_TXLIMIT_get_tx_limit(data)                                             ((0xFFFFFFF8&(data))>>3)
...
#define MD_UR_TXWRPTR_tx_wrptr_mask                                                  (0xFFFFFFFF)
#define MD_UR_TXWRPTR_tx_wrptr(data)                                                 (0xFFFFFFFF&((data)<<0))
#define MD_UR_TXWRPTR_tx_wrptr_src(data)                                             ((0xFFFFFFFF&(data))>>0)
#define MD_UR_TXWRPTR_get_tx_wrptr(data)                                             ((0xFFFFFFFF&(data))>>0)
...
#define MD_UR_TXRDPTR_tx_rdptr_mask                                                  (0xFFFFFFFF)
#define MD_UR_TXRDPTR_tx_rdptr(data)                                                 (0xFFFFFFFF&((data)<<0))
#define MD_UR_TXRDPTR_tx_rdptr_src(data)                                             ((0xFFFFFFFF&(data))>>0)
#define MD_UR_TXRDPTR_get_tx_rdptr(data)                                             ((0xFFFFFFFF&(data))>>0)
...
#define MD_UR_RXBASE_rx_base_mask                                                    (0xFFFFFFF8)
#define MD_UR_RXBASE_rx_base(data)                                                   (0xFFFFFFF8&((data)<<3))
#define MD_UR_RXBASE_rx_base_src(data)                                               ((0xFFFFFFF8&(data))>>3)
#define MD_UR_RXBASE_get_rx_base(data)                                               ((0xFFFFFFF8&(data))>>3)
...
#define MD_UR_RXLIMIT_rx_limit_mask                                                  (0xFFFFFFF8)
#define MD_UR_RXLIMIT_rx_limit(data)                                                 (0xFFFFFFF8&((data)<<3))
#define MD_UR_RXLIMIT_rx_limit_src(data)                                             ((0xFFFFFFF8&(data))>>3)
#define MD_UR_RXLIMIT_get_rx_limit(data)                                             ((0xFFFFFFF8&(data))>>3)
...
#define MD_UR_RXWRPTR_rx_wrptr_mask                                                  (0xFFFFFFFF)
#define MD_UR_RXWRPTR_rx_wrptr(data)                                                 (0xFFFFFFFF&((data)<<0))
#define MD_UR_RXWRPTR_rx_wrptr_src(data)                                             ((0xFFFFFFFF&(data))>>0)
#define MD_UR_RXWRPTR_get_rx_wrptr(data)                                             ((0xFFFFFFFF&(data))>>0)
...
#define MD_UR_RXRDPTR_rx_rdptr_mask                                                  (0xFFFFFFFF)
#define MD_UR_RXRDPTR_rx_rdptr(data)                                                 (0xFFFFFFFF&((data)<<0))
#define MD_UR_RXRDPTR_rx_rdptr_src(data)                                             ((0xFFFFFFFF&(data))>>0)
#define MD_UR_RXRDPTR_get_rx_rdptr(data)                                             ((0xFFFFFFFF&(data))>>0)
...
#define MD_GSP_TXBASE_gsp_tx_base_mask                                               (0xFFFFFFF8)
#define MD_GSP_TXBASE_gsp_tx_base(data)                                              (0xFFFFFFF8&((data)<<3))
#define MD_GSP_TXBASE_gsp_tx_base_src(data)                                          ((0xFFFFFFF8&(data))>>3)
#define MD_GSP_TXBASE_get_gsp_tx_base(data)                                          ((0xFFFFFFF8&(data))>>3)
...
#define MD_GSP_TXLIMIT_gsp_tx_limit_mask                                             (0xFFFFFFF8)
#define MD_GSP_TXLIMIT_gsp_tx_limit(data)                                            (0xFFFFFFF8&((data)<<3))
#define MD_GSP_TXLIMIT_gsp_tx_limit_src(data)                                        ((0xFFFFFFF8&(data))>>3)
#define MD_GSP_TXLIMIT_get_gsp_tx_limit(data)                                        ((0xFFFFFFF8&(data))>>3)
...
#define MD_GSP_TXWRPTR_gsp_tx_wrptr_mask                                             (0xFFFFFFFF)
#define MD_GSP_TXWRPTR_gsp_tx_wrptr(data)                                            (0xFFFFFFFF&((data)<<0))
#define MD_GSP_TXWRPTR_gsp_tx_wrptr_src(data)                                        ((0xFFFFFFFF&(data))>>0)
#define MD_GSP_TXWRPTR_get_gsp_tx_wrptr(data)                                        ((0xFFFFFFFF&(data))>>0)
...
#define MD_GSP_TXRDPTR_gsp_tx_rdptr_mask                                             (0xFFFFFFFF)
#define MD_GSP_TXRDPTR_gsp_tx_rdptr(data)                                            (0xFFFFFFFF&((data)<<0))
#define MD_GSP_TXRDPTR_gsp_tx_rdptr_src(data)                                        ((0xFFFFFFFF&(data))>>0)
#define MD_GSP_TXRDPTR_get_gsp_tx_rdptr(data)                                        ((0xFFFFFFFF&(data))>>0)
...
#define MD_GSP_RXBASE_gsp_rx_base_mask                                               (0xFFFFFFF8)
#define MD_GSP_RXBASE_gsp_rx_base(data)                                              (0xFFFFFFF8&((data)<<3))
#define MD_GSP_RXBASE_gsp_rx_base_src(data)                                          ((0xFFFFFFF8&(data))>>3)
#define MD_GSP_RXBASE_get_gsp_rx_base(data)                                          ((0xFFFFFFF8&(data))>>3)
...
#define MD_GSP_RXLIMIT_gsp_rx_limit_mask                                             (0xFFFFFFF8)
#define MD_GSP_RXLIMIT_gsp_rx_limit(data)                                            (0xFFFFFFF8&((data)<<3))
#define MD_GSP_RXLIMIT_gsp_rx_limit_src(data)                                        ((0xFFFFFFF8&(data))>>3)
#define MD_GSP_RXLIMIT_get_gsp_rx_limit(data)                                        ((0xFFFFFFF8&(data))>>3)
...
#define MD_GSP_RXWRPTR_gsp_rx_wrptr_mask                                             (0xFFFFFFFF)
#define MD_GSP_RXWRPTR_gsp_rx_wrptr(data)                                            (0xFFFFFFFF&((data)<<0))
#define MD_GSP_RXWRPTR_gsp_rx_wrptr_src(data)                                        ((0xFFFFFFFF&(data))>>0)
#define MD_GSP_RXWRPTR_get_gsp_rx_wrptr(data)                                        ((0xFFFFFFFF&(data))>>0)
...
#define MD_GSP_RXRDPTR_gsp_rx_rdptr_mask                                             (0xFFFFFFFF)
#define MD_GSP_RXRDPTR_gsp_rx_rdptr(data)                                            (0xFFFFFFFF&((data)<<0))
#define MD_GSP_RXRDPTR_gsp_rx_rdptr_src(data)                                        ((0xFFFFFFFF&(data))>>0)
#define MD_GSP_RXRDPTR_get_gsp_rx_rdptr(data)                                        ((0xFFFFFFFF&(data))>>0)
...
#define MD_GSP_TXBASICBASE_gsp_txbasic_base_mask                                     (0xFFFFFFF8)
#define MD_GSP_TXBASICBASE_gsp_txbasic_base(data)                                    (0xFFFFFFF8&((data)<<3))
#define MD_GSP_TXBASICBASE_gsp_txbasic_base_src(data)                                ((0xFFFFFFF8&(data))>>3)
#define MD_GSP_TXBASICBASE_get_gsp_txbasic_base(data)                                ((0xFFFFFFF8&(data))>>3)
...
#define MD_GSP_TXBASICLIMIT_gsp_txbasic_limit_mask                                   (0xFFFFFFF8)
#define MD_GSP_TXBASICLIMIT_gsp_txbasic_limit(data)                                  (0xFFFFFFF8&((data)<<3))
#define MD_GSP_TXBASICLIMIT_gsp_txbasic_limit_src(data)                              ((0xFFFFFFF8&(data))>>3)
#define MD_GSP_TXBASICLIMIT_get_gsp_txbasic_limit(data)                              ((0xFFFFFFF8&(data))>>3)
...
#define MD_GSP_TXBASICWRPTR_gsp_txbasic_wrptr_mask                                   (0xFFFFFFFF)
#define MD_GSP_TXBASICWRPTR_gsp_txbasic_wrptr(data)                                  (0xFFFFFFFF&((data)<<0))
#define MD_GSP_TXBASICWRPTR_gsp_txbasic_wrptr_src(data)                              ((0xFFFFFFFF&(data))>>0)
#define MD_GSP_TXBASICWRPTR_get_gsp_txbasic_wrptr(data)                              ((0xFFFFFFFF&(data))>>0)
...
#define MD_GSP_TXBASICRDPTR_gsp_txbasic_rdptr_mask                                   (0xFFFFFFFF)
#define MD_GSP_TXBASICRDPTR_gsp_txbasic_rdptr(data)                                  (0xFFFFFFFF&((data)<<0))
#define MD_GSP_TXBASICRDPTR_gsp_txbasic_rdptr_src(data)                              ((0xFFFFFFFF&(data))>>0)
#define MD_GSP_TXBASICRDPTR_get_gsp_txbasic_rdptr(data)                              ((0xFFFFFFFF&(data))>>0)
...
#define MD_GSP_TXDATBASE_gsp_txdat_base_mask                                         (0xFFFFFFF8)
#define MD_GSP_TXDATBASE_gsp_txdat_base(data)                                        (0xFFFFFFF8&((data)<<3))
#define MD_GSP_TXDATBASE_gsp_txdat_base_src(data)                                    ((0xFFFFFFF8&(data))>>3)
#define MD_GSP_TXDATBASE_get_gsp_txdat_base(data)                                    ((0xFFFFFFF8&(data))>>3)
...
#define MD_GSP_TXDATLIMIT_gsp_txdat_limit_mask                                       (0xFFFFFFF8)
#define MD_GSP_TXDATLIMIT_gsp_txdat_limit(data)                                      (0xFFFFFFF8&((data)<<3))
#define MD_GSP_TXDATLIMIT_gsp_txdat_limit_src(data)                                  ((0xFFFFFFF8&(data))>>3)
#define MD_GSP_TXDATLIMIT_get_gsp_txdat_limit(data)                                  ((0xFFFFFFF8&(data))>>3)
...
#define MD_GSP_TXDATWRPTR_gsp_txdat_wrptr_mask                                       (0xFFFFFFFF)
#define MD_GSP_TXDATWRPTR_gsp_txdat_wrptr(data)                                      (0xFFFFFFFF&((data)<<0))
#define MD_GSP_TXDATWRPTR_gsp_txdat_wrptr_src(data)                                  ((0xFFFFFFFF&(data))>>0)
#define MD_GSP_TXDATWRPTR_get_gsp_txdat_wrptr(data)                                  ((0xFFFFFFFF&(data))>>0)
...
#define MD_GSP_TXDATRDPTR_gsp_txdat_rdptr_mask                                       (0xFFFFFFFF)
#define MD_GSP_TXDATRDPTR_gsp_txdat_rdptr(data)                                      (0xFFFFFFFF&((data)<<0))
#define MD_GSP_TXDATRDPTR_gsp_txdat_rdptr_src(data)                                  ((0xFFFFFFFF&(data))>>0)
#define MD_GSP_TXDATRDPTR_get_gsp_txdat_rdptr(data)                                  ((0xFFFFFFFF&(data))>>0)
...
#define MD_GSP_CTRL                                                                  0x9800B128
#define MD_GSP_CTRL_reg_addr                                                         "0x9800B128"
#define MD_GSP_CTRL_reg                                                              0x9800B128
#define set_MD_GSP_CTRL_reg(data)   (*((volatile unsigned int*) MD_GSP_CTRL_reg)=data)
#define get_MD_GSP_CTRL_reg   (*((volatile unsigned int*) MD_GSP_CTRL_reg))
#define MD_GSP_CTRL_inst_adr                                                         "0x004A"
#define MD_GSP_CTRL_inst                                                             0x004A
#define MD_GSP_CTRL_gsp_cmd_swap_8B_shift                                            (1)
#define MD_GSP_CTRL_gsp_cmd_swap_8B_mask                                             (0x00000002)
#define MD_GSP_CTRL_gsp_cmd_swap_8B(data)                                            (0x00000002&((data)<<1))
#define MD_GSP_CTRL_gsp_cmd_swap_8B_src(data)                                        ((0x00000002&(data))>>1)
#define MD_GSP_CTRL_get_gsp_cmd_swap_8B(data)                                        ((0x00000002&(data))>>1)
#define MD_GSP_CTRL_gsp_cmd_swap_4B_shift                                            (0)
#define MD_GSP_CTRL_gsp_cmd_swap_4B_mask                                             (0x00000001)
#define MD_GSP_CTRL_gsp_cmd_swap_4B(data)                                            (0x00000001&((data)<<0))
#define MD_GSP_CTRL_gsp_cmd_swap_4B_src(data)                                        ((0x00000001&(data))>>0)
#define MD_GSP_CTRL_get_gsp_cmd_swap_4B(data)                                        ((0x00000001&(data))>>0)
...
#define MD_BIST_DVS                                                                  0x9800B12C
#define MD_BIST_DVS_reg_addr                                                         "0x9800B12C"
#define MD_BIST_DVS_reg                                                              0x9800B12C
...
#define MD_BIST_DVS_inst_adr                                                         "0x004B"
#define MD_BIST_DVS_inst                                                             0x004B
#define MD_BIST_DVS_ltsp_shift                                                       (5)
#define MD_BIST_DVS_ltsp_mask                                                        (0x00000020)
#define MD_BIST_DVS_ltsp(data)                                                       (0x00000020&((data)<<5))
#define MD_BIST_DVS_ltsp_src(data)                                                   ((0x00000020&(data))>>5)
#define MD_BIST_DVS_get_ltsp(data)                                                   ((0x00000020&(data))>>5)
#define MD_BIST_DVS_dvse_shift                                                       (4)
#define MD_BIST_DVS_dvse_mask                                                        (0x00000010)
#define MD_BIST_DVS_dvse(data)                                                       (0x00000010&((data)<<4))
#define MD_BIST_DVS_dvse_src(data)                                                   ((0x00000010&(data))>>4)
#define MD_BIST_DVS_get_dvse(data)                                                   ((0x00000010&(data))>>4)
#define MD_BIST_DVS_dvs_3_shift                                                      (3)
#define MD_BIST_DVS_dvs_3_mask                                                       (0x00000008)
#define MD_BIST_DVS_dvs_3(data)                                                      (0x00000008&((data)<<3))
#define MD_BIST_DVS_dvs_3_src(data)                                                  ((0x00000008&(data))>>3)
#define MD_BIST_DVS_get_dvs_3(data)                                                  ((0x00000008&(data))>>3)
#define MD_BIST_DVS_dvs_2_shift                                                      (2)
#define MD_BIST_DVS_dvs_2_mask                                                       (0x00000004)
#define MD_BIST_DVS_dvs_2(data)                                                      (0x00000004&((data)<<2))
#define MD_BIST_DVS_dvs_2_src(data)                                                  ((0x00000004&(data))>>2)
#define MD_BIST_DVS_get_dvs_2(data)                                                  ((0x00000004&(data))>>2)
#define MD_BIST_DVS_dvs_1_shift                                                      (1)
#define MD_BIST_DVS_dvs_1_mask                                                       (0x00000002)
#define MD_BIST_DVS_dvs_1(data)                                                      (0x00000002&((data)<<1))
#define MD_BIST_DVS_dvs_1_src(data)                                                  ((0x00000002&(data))>>1)
#define MD_BIST_DVS_get_dvs_1(data)                                                  ((0x00000002&(data))>>1)
#define MD_BIST_DVS_dvs_0_shift                                                      (0)
#define MD_BIST_DVS_dvs_0_mask                                                       (0x00000001)
#define MD_BIST_DVS_dvs_0(data)                                                      (0x00000001&((data)<<0))
#define MD_BIST_DVS_dvs_0_src(data)                                                  ((0x00000001&(data))>>0)
#define MD_BIST_DVS_get_dvs_0(data)                                                  ((0x00000001&(data))>>0)


#define MD_BIST_ST                                                                   0x9800B130
#define MD_BIST_ST_reg_addr                                                          "0x9800B130"
#define MD_BIST_ST_reg                                                               0x9800B130
#define set_MD_BIST_ST_reg(data)   (*((volatile unsigned int*) MD_BIST_ST_reg)=data)
#define get_MD_BIST_ST_reg   (*((volatile unsigned int*) MD_BIST_ST_reg))
#define MD_BIST_ST_inst_adr                                                          "0x004C"
#define MD_BIST_ST_inst                                                              0x004C
#define MD_BIST_ST_bist_fail2_shift                                                  (3)
#define MD_BIST_ST_bist_fail2_mask                                                   (0x00000008)
#define MD_BIST_ST_bist_fail2(data)                                                  (0x00000008&((data)<<3))
#define MD_BIST_ST_bist_fail2_src(data)                                              ((0x00000008&(data))>>3)
#define MD_BIST_ST_get_bist_fail2(data)                                              ((0x00000008&(data))>>3)
#define MD_BIST_ST_bist_fail1_shift                                                  (2)
#define MD_BIST_ST_bist_fail1_mask                                                   (0x00000004)
#define MD_BIST_ST_bist_fail1(data)                                                  (0x00000004&((data)<<2))
#define MD_BIST_ST_bist_fail1_src(data)                                              ((0x00000004&(data))>>2)
#define MD_BIST_ST_get_bist_fail1(data)                                              ((0x00000004&(data))>>2)
#define MD_BIST_ST_bist_fail0_shift                                                  (1)
#define MD_BIST_ST_bist_fail0_mask                                                   (0x00000002)
#define MD_BIST_ST_bist_fail0(data)                                                  (0x00000002&((data)<<1))
#define MD_BIST_ST_bist_fail0_src(data)                                              ((0x00000002&(data))>>1)
#define MD_BIST_ST_get_bist_fail0(data)                                              ((0x00000002&(data))>>1)
#define MD_BIST_ST_bist_done_shift                                                   (0)
#define MD_BIST_ST_bist_done_mask                                                    (0x00000001)
#define MD_BIST_ST_bist_done(data)                                                   (0x00000001&((data)<<0))
#define MD_BIST_ST_bist_done_src(data)                                               ((0x00000001&(data))>>0)
#define MD_BIST_ST_get_bist_done(data)                                               ((0x00000001&(data))>>0)


#define MD_DRF_ST                                                                    0x9800B134
#define MD_DRF_ST_reg_addr                                                           "0x9800B134"
#define MD_DRF_ST_reg                                                                0x9800B134
#define set_MD_DRF_ST_reg(data)   (*((volatile unsigned int*) MD_DRF_ST_reg)=data)
#define get_MD_DRF_ST_reg   (*((volatile unsigned int*) MD_DRF_ST_reg))
#define MD_DRF_ST_inst_adr                                                           "0x004D"
#define MD_DRF_ST_inst                                                               0x004D
#define MD_DRF_ST_drf_start_pause_shift                                              (16)
#define MD_DRF_ST_drf_start_pause_mask                                               (0x00010000)
#define MD_DRF_ST_drf_start_pause(data)                                              (0x00010000&((data)<<16))
#define MD_DRF_ST_drf_start_pause_src(data)                                          ((0x00010000&(data))>>16)
#define MD_DRF_ST_get_drf_start_pause(data)                                          ((0x00010000&(data))>>16)
#define MD_DRF_ST_drf_fail2_shift                                                    (3)
#define MD_DRF_ST_drf_fail2_mask                                                     (0x00000008)
#define MD_DRF_ST_drf_fail2(data)                                                    (0x00000008&((data)<<3))
#define MD_DRF_ST_drf_fail2_src(data)                                                ((0x00000008&(data))>>3)
#define MD_DRF_ST_get_drf_fail2(data)                                                ((0x00000008&(data))>>3)
#define MD_DRF_ST_drf_fail1_shift                                                    (2)
#define MD_DRF_ST_drf_fail1_mask                                                     (0x00000004)
#define MD_DRF_ST_drf_fail1(data)                                                    (0x00000004&((data)<<2))
#define MD_DRF_ST_drf_fail1_src(data)                                                ((0x00000004&(data))>>2)
#define MD_DRF_ST_get_drf_fail1(data)                                                ((0x00000004&(data))>>2)
#define MD_DRF_ST_drf_fail0_shift                                                    (1)
#define MD_DRF_ST_drf_fail0_mask                                                     (0x00000002)
#define MD_DRF_ST_drf_fail0(data)                                                    (0x00000002&((data)<<1))
#define MD_DRF_ST_drf_fail0_src(data)                                                ((0x00000002&(data))>>1)
#define MD_DRF_ST_get_drf_fail0(data)                                                ((0x00000002&(data))>>1)
#define MD_DRF_ST_drf_done_shift                                                     (0)
#define MD_DRF_ST_drf_done_mask                                                      (0x00000001)
#define MD_DRF_ST_drf_done(data)                                                     (0x00000001&((data)<<0))
#define MD_DRF_ST_drf_done_src(data)                                                 ((0x00000001&(data))>>0)
#define MD_DRF_ST_get_drf_done(data)                                                 ((0x00000001&(data))>>0)


#define MD_MBIST_CON                                                                 0x9800B138
#define MD_MBIST_CON_reg_addr                                                        "0x9800B138"
#define MD_MBIST_CON_reg                                                             0x9800B138
#define set_MD_MBIST_CON_reg(data)   (*((volatile unsigned int*) MD_MBIST_CON_reg)=data)
#define get_MD_MBIST_CON_reg   (*((volatile unsigned int*) MD_MBIST_CON_reg))
#define MD_MBIST_CON_inst_adr                                                        "0x004E"
#define MD_MBIST_CON_inst                                                            0x004E
#define MD_MBIST_CON_drf_test_resume_shift                                           (2)
#define MD_MBIST_CON_drf_test_resume_mask                                            (0x00000004)
#define MD_MBIST_CON_drf_test_resume(data)                                           (0x00000004&((data)<<2))
#define MD_MBIST_CON_drf_test_resume_src(data)                                       ((0x00000004&(data))>>2)
#define MD_MBIST_CON_get_drf_test_resume(data)                                       ((0x00000004&(data))>>2)
#define MD_MBIST_CON_drf_bist_mode_shift                                             (1)
#define MD_MBIST_CON_drf_bist_mode_mask                                              (0x00000002)
#define MD_MBIST_CON_drf_bist_mode(data)                                             (0x00000002&((data)<<1))
#define MD_MBIST_CON_drf_bist_mode_src(data)                                         ((0x00000002&(data))>>1)
#define MD_MBIST_CON_get_drf_bist_mode(data)                                         ((0x00000002&(data))>>1)
#define MD_MBIST_CON_bist_mode_shift                                                 (0)
#define MD_MBIST_CON_bist_mode_mask                                                  (0x00000001)
#define MD_MBIST_CON_bist_mode(data)                                                 (0x00000001&((data)<<0))
#define MD_MBIST_CON_bist_mode_src(data)                                             ((0x00000001&(data))>>0)
#define MD_MBIST_CON_get_bist_mode(data)                                             ((0x00000001&(data))>>0)
...
#define MD_UR2_TXBASE                                                                0x9800B150
#define MD_UR2_TXBASE_reg_addr                                                       "0x9800B150"
#define MD_UR2_TXBASE_reg                                                            0x9800B150
#define set_MD_UR2_TXBASE_reg(data)   (*((volatile unsigned int*) MD_UR2_TXBASE_reg)=data)
#define get_MD_UR2_TXBASE_reg   (*((volatile unsigned int*) MD_UR2_TXBASE_reg))
#define MD_UR2_TXBASE_inst_adr                                                       "0x0054"
#define MD_UR2_TXBASE_inst                                                           0x0054
#define MD_UR2_TXBASE_ur2_tx_base_shift                                              (3)
#define MD_UR2_TXBASE_ur2_tx_base_mask                                               (0xFFFFFFF8)
#define MD_UR2_TXBASE_ur2_tx_base(data)                                              (0xFFFFFFF8&((data)<<3))
#define MD_UR2_TXBASE_ur2_tx_base_src(data)                                          ((0xFFFFFFF8&(data))>>3)
#define MD_UR2_TXBASE_get_ur2_tx_base(data)                                          ((0xFFFFFFF8&(data))>>3)


#define MD_UR2_TXLIMIT                                                               0x9800B154
#define MD_UR2_TXLIMIT_reg_addr                                                      "0x9800B154"
#define MD_UR2_TXLIMIT_reg                                                           0x9800B154
#define set_MD_UR2_TXLIMIT_reg(data)   (*((volatile unsigned int*) MD_UR2_TXLIMIT_reg)=data)
#define get_MD_UR2_TXLIMIT_reg   (*((volatile unsigned int*) MD_UR2_TXLIMIT_reg))
#define MD_UR2_TXLIMIT_inst_adr                                                      "0x0055"
#define MD_UR2_TXLIMIT_inst                                                          0x0055
#define MD_UR2_TXLIMIT_ur2_tx_limit_shift                                            (3)
#define MD_UR2_TXLIMIT_ur2_tx_limit_mask                                             (0xFFFFFFF8)
#define MD_UR2_TXLIMIT_ur2_tx_limit(data)                                            (0xFFFFFFF8&((data)<<3))
#define MD_UR2_TXLIMIT_ur2_tx_limit_src(data)                                        ((0xFFFFFFF8&(data))>>3)
#define MD_UR2_TXLIMIT_get_ur2_tx_limit(data)                                        ((0xFFFFFFF8&(data))>>3)


#define MD_UR2_TXWRPTR                                                               0x9800B158
#define MD_UR2_TXWRPTR_reg_addr                                                      "0x9800B158"
#define MD_UR2_TXWRPTR_reg                                                           0x9800B158
#define set_MD_UR2_TXWRPTR_reg(data)   (*((volatile unsigned int*) MD_UR2_TXWRPTR_reg)=data)
#define get_MD_UR2_TXWRPTR_reg   (*((volatile unsigned int*) MD_UR2_TXWRPTR_reg))
#define MD_UR2_TXWRPTR_inst_adr                                                      "0x0056"
#define MD_UR2_TXWRPTR_inst                                                          0x0056
#define MD_UR2_TXWRPTR_ur2_tx_wrptr_shift                                            (0)
#define MD_UR2_TXWRPTR_ur2_tx_wrptr_mask                                             (0xFFFFFFFF)
#define MD_UR2_TXWRPTR_ur2_tx_wrptr(data)                                            (0xFFFFFFFF&((data)<<0))
#define MD_UR2_TXWRPTR_ur2_tx_wrptr_src(data)                                        ((0xFFFFFFFF&(data))>>0)
#define MD_UR2_TXWRPTR_get_ur2_tx_wrptr(data)                                        ((0xFFFFFFFF&(data))>>0)


#define MD_UR2_TXRDPTR                                                               0x9800B15C
#define MD_UR2_TXRDPTR_reg_addr                                                      "0x9800B15C"
#define MD_UR2_TXRDPTR_reg                                                           0x9800B15C
#define set_MD_UR2_TXRDPTR_reg(data)   (*((volatile unsigned int*) MD_UR2_TXRDPTR_reg)=data)
#define get_MD_UR2_TXRDPTR_reg   (*((volatile unsigned int*) MD_UR2_TXRDPTR_reg))
#define MD_UR2_TXRDPTR_inst_adr                                                      "0x0057"
#define MD_UR2_TXRDPTR_inst                                                          0x0057
#define MD_UR2_TXRDPTR_ur2_tx_rdptr_shift                                            (0)
#define MD_UR2_TXRDPTR_ur2_tx_rdptr_mask                                             (0xFFFFFFFF)
#define MD_UR2_TXRDPTR_ur2_tx_rdptr(data)                                            (0xFFFFFFFF&((data)<<0))
#define MD_UR2_TXRDPTR_ur2_tx_rdptr_src(data)                                        ((0xFFFFFFFF&(data))>>0)
#define MD_UR2_TXRDPTR_get_ur2_tx_rdptr(data)                                        ((0xFFFFFFFF&(data))>>0)


#define MD_UR2_TXTHD                                                                 0x9800B160
#define MD_UR2_TXTHD_reg_addr                                                        "0x9800B160"
#define MD_UR2_TXTHD_reg                                                             0x9800B160
#define set_MD_UR2_TXTHD_reg(data)   (*((volatile unsigned int*) MD_UR2_TXTHD_reg)=data)
#define get_MD_UR2_TXTHD_reg   (*((volatile unsigned int*) MD_UR2_TXTHD_reg))
#define MD_UR2_TXTHD_inst_adr                                                        "0x0058"
#define MD_UR2_TXTHD_inst                                                            0x0058
#define MD_UR2_TXTHD_ur2_tx_thd_shift                                                (0)
#define MD_UR2_TXTHD_ur2_tx_thd_mask                                                 (0xFFFFFFFF)
#define MD_UR2_TXTHD_ur2_tx_thd(data)                                                (0xFFFFFFFF&((data)<<0))
#define MD_UR2_TXTHD_ur2_tx_thd_src(data)                                            ((0xFFFFFFFF&(data))>>0)
#define MD_UR2_TXTHD_get_ur2_tx_thd(data)                                            ((0xFFFFFFFF&(data))>>0)


#define MD_UR2_RXBASE                                                                0x9800B164
#define MD_UR2_RXBASE_reg_addr                                                       "0x9800B164"
#define MD_UR2_RXBASE_reg                                                            0x9800B164
#define set_MD_UR2_RXBASE_reg(data)   (*((volatile unsigned int*) MD_UR2_RXBASE_reg)=data)
#define get_MD_UR2_RXBASE_reg   (*((volatile unsigned int*) MD_UR2_RXBASE_reg))
#define MD_UR2_RXBASE_inst_adr                                                       "0x0059"
#define MD_UR2_RXBASE_inst                                                           0x0059
#define MD_UR2_RXBASE_ur2_rx_base_shift                                              (3)
#define MD_UR2_RXBASE_ur2_rx_base_mask                                               (0xFFFFFFF8)
#define MD_UR2_RXBASE_ur2_rx_base(data)                                              (0xFFFFFFF8&((data)<<3))
#define MD_UR2_RXBASE_ur2_rx_base_src(data)                                          ((0xFFFFFFF8&(data))>>3)
#define MD_UR2_RXBASE_get_ur2_rx_base(data)                                          ((0xFFFFFFF8&(data))>>3)


#define MD_UR2_RXLIMIT                                                               0x9800B168
#define MD_UR2_RXLIMIT_reg_addr                                                      "0x9800B168"
#define MD_UR2_RXLIMIT_reg                                                           0x9800B168
#define set_MD_UR2_RXLIMIT_reg(data)   (*((volatile unsigned int*) MD_UR2_RXLIMIT_reg)=data)
#define get_MD_UR2_RXLIMIT_reg   (*((volatile unsigned int*) MD_UR2_RXLIMIT_reg))
#define MD_UR2_RXLIMIT_inst_adr                                                      "0x005A"
#define MD_UR2_RXLIMIT_inst                                                          0x005A
#define MD_UR2_RXLIMIT_ur2_rx_limit_shift                                            (3)
#define MD_UR2_RXLIMIT_ur2_rx_limit_mask                                             (0xFFFFFFF8)
#define MD_UR2_RXLIMIT_ur2_rx_limit(data)                                            (0xFFFFFFF8&((data)<<3))
#define MD_UR2_RXLIMIT_ur2_rx_limit_src(data)                                        ((0xFFFFFFF8&(data))>>3)
#define MD_UR2_RXLIMIT_get_ur2_rx_limit(data)                                        ((0xFFFFFFF8&(data))>>3)


#define MD_UR2_RXWRPTR                                                               0x9800B16C
#define MD_UR2_RXWRPTR_reg_addr                                                      "0x9800B16C"
#define MD_UR2_RXWRPTR_reg                                                           0x9800B16C
#define set_MD_UR2_RXWRPTR_reg(data)   (*((volatile unsigned int*) MD_UR2_RXWRPTR_reg)=data)
#define get_MD_UR2_RXWRPTR_reg   (*((volatile unsigned int*) MD_UR2_RXWRPTR_reg))
#define MD_UR2_RXWRPTR_inst_adr                                                      "0x005B"
#define MD_UR2_RXWRPTR_inst                                                          0x005B
#define MD_UR2_RXWRPTR_ur2_rx_wrptr_shift                                            (0)
#define MD_UR2_RXWRPTR_ur2_rx_wrptr_mask                                             (0xFFFFFFFF)
#define MD_UR2_RXWRPTR_ur2_rx_wrptr(data)                                            (0xFFFFFFFF&((data)<<0))
#define MD_UR2_RXWRPTR_ur2_rx_wrptr_src(data)                                        ((0xFFFFFFFF&(data))>>0)
#define MD_UR2_RXWRPTR_get_ur2_rx_wrptr(data)                                        ((0xFFFFFFFF&(data))>>0)


#define MD_UR2_RXRDPTR                                                               0x9800B170
#define MD_UR2_RXRDPTR_reg_addr                                                      "0x9800B170"
#define MD_UR2_RXRDPTR_reg                                                           0x9800B170
#define set_MD_UR2_RXRDPTR_reg(data)   (*((volatile unsigned int*) MD_UR2_RXRDPTR_reg)=data)
#define get_MD_UR2_RXRDPTR_reg   (*((volatile unsigned int*) MD_UR2_RXRDPTR_reg))
#define MD_UR2_RXRDPTR_inst_adr                                                      "0x005C"
#define MD_UR2_RXRDPTR_inst                                                          0x005C
#define MD_UR2_RXRDPTR_ur2_rx_rdptr_shift                                            (0)
#define MD_UR2_RXRDPTR_ur2_rx_rdptr_mask                                             (0xFFFFFFFF)
#define MD_UR2_RXRDPTR_ur2_rx_rdptr(data)                                            (0xFFFFFFFF&((data)<<0))
#define MD_UR2_RXRDPTR_ur2_rx_rdptr_src(data)                                        ((0xFFFFFFFF&(data))>>0)
#define MD_UR2_RXRDPTR_get_ur2_rx_rdptr(data)                                        ((0xFFFFFFFF&(data))>>0)


#define MD_UR2_RXTHD                                                                 0x9800B174
#define MD_UR2_RXTHD_reg_addr                                                        "0x9800B174"
#define MD_UR2_RXTHD_reg                                                             0x9800B174
#define set_MD_UR2_RXTHD_reg(data)   (*((volatile unsigned int*) MD_UR2_RXTHD_reg)=data)
#define get_MD_UR2_RXTHD_reg   (*((volatile unsigned int*) MD_UR2_RXTHD_reg))
#define MD_UR2_RXTHD_inst_adr                                                        "0x005D"
#define MD_UR2_RXTHD_inst                                                            0x005D
#define MD_UR2_RXTHD_ur2_rx_thd_shift                                                (0)
#define MD_UR2_RXTHD_ur2_rx_thd_mask                                                 (0xFFFFFFFF)
#define MD_UR2_RXTHD_ur2_rx_thd(data)                                                (0xFFFFFFFF&((data)<<0))
#define MD_UR2_RXTHD_ur2_rx_thd_src(data)                                            ((0xFFFFFFFF&(data))>>0)
#define MD_UR2_RXTHD_get_ur2_rx_thd(data)                                            ((0xFFFFFFFF&(data))>>0)


#define MD_UR2_ENABLE                                                                0x9800B178
#define MD_UR2_ENABLE_reg_addr                                                       "0x9800B178"
#define MD_UR2_ENABLE_reg                                                            0x9800B178
#define set_MD_UR2_ENABLE_reg(data)   (*((volatile unsigned int*) MD_UR2_ENABLE_reg)=data)
#define get_MD_UR2_ENABLE_reg   (*((volatile unsigned int*) MD_UR2_ENABLE_reg))
#define MD_UR2_ENABLE_inst_adr                                                       "0x005E"
#define MD_UR2_ENABLE_inst                                                           0x005E
#define MD_UR2_ENABLE_ur2_ur_en_shift                                                (0)
#define MD_UR2_ENABLE_ur2_ur_en_mask                                                 (0x00000001)
#define MD_UR2_ENABLE_ur2_ur_en(data)                                                (0x00000001&((data)<<0))
#define MD_UR2_ENABLE_ur2_ur_en_src(data)                                            ((0x00000001&(data))>>0)
#define MD_UR2_ENABLE_get_ur2_ur_en(data)                                            ((0x00000001&(data))>>0)


#define MD_CTRL                                                                      0x9800B180
#define MD_CTRL_reg_addr                                                             "0x9800B180"
#define MD_CTRL_reg                                                                  0x9800B180
#define set_MD_CTRL_reg(data)   (*((volatile unsigned int*) MD_CTRL_reg)=data)
#define get_MD_CTRL_reg   (*((volatile unsigned int*) MD_CTRL_reg))
#define MD_CTRL_inst_adr                                                             "0x0060"
#define MD_CTRL_inst                                                                 0x0060
#define MD_CTRL_endian_sel_shift                                                     (8)
#define MD_CTRL_endian_sel_mask                                                      (0x00000100)
#define MD_CTRL_endian_sel(data)                                                     (0x00000100&((data)<<8))
#define MD_CTRL_endian_sel_src(data)                                                 ((0x00000100&(data))>>8)
#define MD_CTRL_get_endian_sel(data)                                                 ((0x00000100&(data))>>8)
#define MD_CTRL_db1_ls_en_shift                                                      (3)
#define MD_CTRL_db1_ls_en_mask                                                       (0x00000008)
#define MD_CTRL_db1_ls_en(data)                                                      (0x00000008&((data)<<3))
#define MD_CTRL_db1_ls_en_src(data)                                                  ((0x00000008&(data))>>3)
#define MD_CTRL_get_db1_ls_en(data)                                                  ((0x00000008&(data))>>3)
#define MD_CTRL_db0_ls_en_shift                                                      (2)
#define MD_CTRL_db0_ls_en_mask                                                       (0x00000004)
#define MD_CTRL_db0_ls_en(data)                                                      (0x00000004&((data)<<2))
#define MD_CTRL_db0_ls_en_src(data)                                                  ((0x00000004&(data))>>2)
#define MD_CTRL_get_db0_ls_en(data)                                                  ((0x00000004&(data))>>2)
#define MD_CTRL_ib_ls_en_shift                                                       (1)
#define MD_CTRL_ib_ls_en_mask                                                        (0x00000002)
#define MD_CTRL_ib_ls_en(data)                                                       (0x00000002&((data)<<1))
#define MD_CTRL_ib_ls_en_src(data)                                                   ((0x00000002&(data))>>1)
#define MD_CTRL_get_ib_ls_en(data)                                                   ((0x00000002&(data))>>1)
#define MD_CTRL_gating_en_shift                                                      (0)
#define MD_CTRL_gating_en_mask                                                       (0x00000001)
#define MD_CTRL_gating_en(data)                                                      (0x00000001&((data)<<0))
#define MD_CTRL_gating_en_src(data)                                                  ((0x00000001&(data))>>0)
#define MD_CTRL_get_gating_en(data)                                                  ((0x00000001&(data))>>0)
