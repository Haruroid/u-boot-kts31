...
#ifdef SCPU_ARM 
#define TEST_PASS              0x00303000
#define TEST_FAIL              0x00303100
#else
...
#define HW_INTVEC_ADDR7        HW_INTVEC_ADDR7_SCPU
  ...
  #define SET_INT(id, scpu_isr)  ((*((volatile*) ( ((unsigned int*)0x03F0B000)+ id))) = (void*) scpu_isr)
#endif
...
#include "mipi_ccs_reg.h"
#include "sc_wrap_reg.h"
#include "sc_wrap_dvfs_reg.h"
#include "arm_iso_reg.h"
#include "sbx_reg.h"
#include "me_reg.h"
#include "ve_reg.h"
#include "nat_reg.h"
...
#include "pcie11_reg.h"
#include "pcie20_reg.h"
...
/**********************************************************/
#define SCPU_DUMMY_BIT   0x00000001
#define AIO_DUMMY_BIT    0x00000010
#define VO0_DUMMY_BIT    0x00000020
#define VO1_DUMMY_BIT    0x00000040
#define VO2_DUMMY_BIT    0x00000080
#define VO3_DUMMY_BIT    0x00000100
#define MD_DUMMY_BIT     0x00000200
#define CP_DUMMY_BIT     0x00000400
#define TP_DUMMY_BIT     0x00000800
#define NAT_DUMMY_BIT    0x00001000
#define JPEG_DUMMY_BIT   0x00002000
#define AEE_DUMMY_BIT    0x00004000
#define ADE_DUMMY_BIT    0x00008000
#define ETN_DUMMY_BIT    0x00010000
#define NF_DUMMY_BIT     0x00020000
#define PCIE_DUMMY_BIT   0x00040000
#define PCIE2_DUMMY_BIT  0x00080000
#define USB_DUMMY_BIT    0x00100000
#define CR_DUMMY_BIT     0x00200000
#define SE_DUMMY_BIT     0x00400000
#define MIPI_DUMMY_BIT   0x00800000
#define GPU_DUMMY_BIT    0x01000000
#define SATA_DUMMY_BIT   0x02000000
#define VE1_DUMMY_BIT    0x04000000
#define VE2_DUMMY_BIT    0x08000000
#define VE3_DUMMY_BIT    0x10000000
#define NAT2_DUMMY_BIT   0x20000000
#define SB2_DUMMY_BIT    0x40000000

#define DC_TEST_GO_SCPU   la reg1, SB2_DUMMY_0_reg;  li reg2 0x0001; sw reg2,0(reg1)
#define DC_TEST_GO_AO     la reg1, SB2_DUMMY_0_reg;  li reg2 0x0010; sw reg2,0(reg1)
#define DC_TEST_GO_VO0    la reg1, SB2_DUMMY_0_reg;  li reg2 0x0020; sw reg2,0(reg1)
#define DC_TEST_GO_VO1    la reg1, SB2_DUMMY_0_reg;  li reg2 0x0040; sw reg2,0(reg1)
#define DC_TEST_GO_VO2    la reg1, SB2_DUMMY_0_reg;  li reg2 0x0080; sw reg2,0(reg1)
#define DC_TEST_GO_VO3    la reg1, SB2_DUMMY_0_reg;  li reg2 0x0100; sw reg2,0(reg1)
#define DC_TEST_GO_MD     la reg1, SB2_DUMMY_0_reg;  li reg2 0x0200; sw reg2,0(reg1)
#define DC_TEST_GO_CP     la reg1, SB2_DUMMY_0_reg;  li reg2 0x0400; sw reg2,0(reg1)
#define DC_TEST_GO_TP     la reg1, SB2_DUMMY_0_reg;  li reg2 0x0800; sw reg2,0(reg1)
#define DC_TEST_GO_NAT    la reg1, SB2_DUMMY_0_reg;  li reg2 0x1000; sw reg2,0(reg1)
#define DC_TEST_GO_JPEG   la reg1, SB2_DUMMY_0_reg;  li reg2 0x2000; sw reg2,0(reg1)
#define DC_TEST_GO_AEE    la reg1, SB2_DUMMY_0_reg;  li reg2 0x4000; sw reg2,0(reg1)
#define DC_TEST_GO_ADE    la reg1, SB2_DUMMY_0_reg;  li reg2 0x8000; sw reg2,0(reg1)
#define DC_TEST_GO_ETN    la reg1, SB2_DUMMY_0_reg; lui reg2 0x0001; sw reg2,0(reg1)
#define DC_TEST_GO_NF     la reg1, SB2_DUMMY_0_reg; lui reg2 0x0002; sw reg2,0(reg1)
#define DC_TEST_GO_PCIE   la reg1, SB2_DUMMY_0_reg; lui reg2 0x0004; sw reg2,0(reg1)
#define DC_TEST_GO_PCIE2  la reg1, SB2_DUMMY_0_reg; lui reg2 0x0008; sw reg2,0(reg1)
#define DC_TEST_GO_USB    la reg1, SB2_DUMMY_0_reg; lui reg2 0x0010; sw reg2,0(reg1)
#define DC_TEST_GO_CR     la reg1, SB2_DUMMY_0_reg; lui reg2 0x0020; sw reg2,0(reg1)
#define DC_TEST_GO_SE     la reg1, SB2_DUMMY_0_reg; lui reg2 0x0040; sw reg2,0(reg1)
#define DC_TEST_GO_MIPI   la reg1, SB2_DUMMY_0_reg; lui reg2 0x0080; sw reg2,0(reg1)
#define DC_TEST_GO_GPU    la reg1, SB2_DUMMY_0_reg; lui reg2 0x0100; sw reg2,0(reg1)
#define DC_TEST_GO_SATA   la reg1, SB2_DUMMY_0_reg; lui reg2 0x0200; sw reg2,0(reg1)
#define DC_TEST_GO_VE1    la reg1, SB2_DUMMY_0_reg; lui reg2 0x0400; sw reg2,0(reg1)
#define DC_TEST_GO_VE2    la reg1, SB2_DUMMY_0_reg; lui reg2 0x0800; sw reg2,0(reg1)
#define DC_TEST_GO_VE3    la reg1, SB2_DUMMY_0_reg; lui reg2 0x1000; sw reg2,0(reg1)
#define DC_TEST_GO_NAT2   la reg1, SB2_DUMMY_0_reg; lui reg2 0x2000; sw reg2,0(reg1)
#define DC_TEST_GO_SB2    la reg1, SB2_DUMMY_0_reg; lui reg2 0x4000; sw reg2,0(reg1)
...
#define DELAY_C(count) \
    {volatile register i; for(i=count; i>0; i--);}
...
//use "ori zero, 0x8898" op=34008898 to distinguish
  ...
  #define WAIT_C(addr,mask,value) \
          while( ((*((volatile unsigned int*) addr))&mask)!=value );
...
1:  add   reg2, 1;                                 \
    ...
    la    reg2, SB2_HD_SEM_reg;                    \
    sw    zero, (reg2);                            \
    WAIT(0xd801a024, 0x1f, num_of_cpu, reg1, reg2);
...
1:  add   reg2, 1;                              \
    ...
    la    reg2, SB2_HD_SEM_reg;                 \
    sw    zero, (reg2);                         \
    WAIT(0xd801a024, 0x3, 0x3, reg1, reg2);
